...
DEFAULT_FROM_EMAIL = 'Play Vision <info@playvision.com.ua>'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 52428800  # 50 MB (для великих SVG в TextField)
...
SENDPULSE_ADDRESS_BOOK_MENTORING = config('SENDPULSE_ADDRESS_BOOK_MENTORING', default=497185, cast=int)
SENDPULSE_ADDRESS_BOOK_SUBSCRIPTION = config('SENDPULSE_ADDRESS_BOOK_SUBSCRIPTION', default=497186, cast=int)
