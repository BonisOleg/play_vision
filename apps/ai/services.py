...
class MockLLMClient(LLMClientInterface):
    ...
    def generate(self, prompt: str) -> Dict[str, Any]:
        ...
        mock_responses = {
            'що таке play vision': 'Play Vision - це освітня платформа для футбольних фахівців, що надає доступ до курсів, івентів та ментор коучингу від провідних експертів галузі.',
