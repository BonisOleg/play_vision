...
class CourseAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'price', 'has_discount', 'is_top_seller', 'is_coming_soon', 'is_new', 'is_featured', 'is_published', 
                   'view_count', 'enrollment_count', 'created_at')
    list_filter = ('is_featured', 'is_free', 'is_published', 'has_discount', 'is_top_seller', 'is_coming_soon', 'is_new',
    ...
    fieldsets = (
        ...
        ('🏷️ Бейджі та знижки', {
            'fields': ('has_discount', 'discount_percent', 'is_top_seller', 'is_coming_soon', 'is_new'),
            'description': '''
                <div style="background: #f0f8ff; padding: 12px; border-left: 4px solid #2196F3; margin: 10px 0;">
                    ...
                    <p><strong>🔵 Незабаром:</strong> Активуйте для відображення синього бейджу</p>
                    <p><strong>🟣 Новинка:</strong> Активуйте для відображення фіолетового бейджу</p>
                    <p>💡 Можна використовувати кілька бейджів одночасно</p>
                </div>
            '''
        }),
