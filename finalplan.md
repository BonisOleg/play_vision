...
1. **Білі РАМКИ** в hero секції (НЕ заливка) - це дуже важливо!
...
- **Існуючі модулі:**
  ...
  - mentoring (ментор-коучинг - базова структура)
...
- templates/base/base.html містить хедер:
  ...
  - Розділи меню: Головна, Про нас, Хаб знань, Івенти, Ментор-коучинг
  - Кнопки праворуч:
...
**ЩО ТРЕБА:**
- Логотип Play Vision має бути чітко видимий
...
**ЩО ПОТРІБНО ДОРОБИТИ:**
- Перевірити що SVG файли правильно відображаються
...
- HexagonItem - для гексагонів ментор-коучингу
...
#### 8.1. Окрема сторінка "Ментор-коучинг" з 5 блоками

**ЩО ТРЕБА:**
- Блок 1: Що таке Ментор-коучинг? (3 абзаци тексту)
- Блок 2: Структура Ментор-коучингу (6 шестикутників)
- Блок 3: Команда Ментор-коучингу (текст + структура)
...
#### 8.3. Команда Ментор-коучингу

**ЩО ТРЕБА:**
- Текст про команду (works 24/7, підтримка...)
- Структура: Ментор-менеджер, Координатор, Ментор-коучи, Спеціалісти
...
**ЩО ТРЕБА:**
- Додати секцію з текстом про місію Play Vision
...
1. **Логотип Play Vision:**
   - Має бути завжди чітко видимий у header
...
- ⚠️ Контент (40% → 100%)
- ⚠️ Ментор-коучинг сторінка (10% → 100%)
...
- [ ] Сторінка Ментор-коучинг (5 блоків тексту)
- [ ] БРЕНД-АБЗАЦ "Про нас"
...
| 8 | Ментор-коучинг | 5 блоків, 6 напрямків детально | Coming soon заглушка | 15% | Повна сторінка з нуля |
...
1. **Сторінка Ментор-коучинг** - 1 тиждень
...
- Course authors: Олексій + Микита (Ментор-коучинг)
- About page: Євген
...
2. Створити сторінку Ментор-коучинг
